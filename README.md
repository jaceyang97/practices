...
![pieces](https://img.shields.io/badge/sketches-75-1f6feb?style=flat-square)
...
- Sketches live in [`artworks/`](artworks/) as vanilla p5.js / three.js scripts (`p0.js` … `p75.js`).
