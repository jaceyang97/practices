/**
 * Generative Art exercise (shown at 6:11 in Tim Holman's Speedrun talk, CSSConf Australia 2018).
 * Source: https://www.youtube.com/watch?v=4Se0_w0ISYk
 * Code by Jace Yang.
 *
 * Practice 5: Tiling - Horizontal and Vertical Lines
 */
...
function drawTilingLines() {
    ...
    for(let i = 0; i < tileCount; i++) {
        for(let j = 0; j < tileCount; j++) {
            ...
            // Draw horizontal or vertical line randomly
            if (directions[i][j]) {
                // Horizontal line (centered vertically)
                line(x, y + tileStep/2, x + stepPlus, y + tileStep/2);
            } else {
                // Vertical line (centered horizontally)
                line(x + tileStep/2, y, x + tileStep/2, y + stepPlus);
            }
        }
    }
    pop();
